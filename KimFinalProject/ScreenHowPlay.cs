...
namespace KimFinalProject
{
    ...
    /// </summary>
    public class ScreenHowPlay : Screen
    {
        ...
        public ScreenHowPlay(Game game, SpriteBatch spriteBatch) : base(game)
        {
            this.spriteBatch = spriteBatch;
            texture = game.Content.Load<Texture2D>("images/screenHowToPlay");
        }
